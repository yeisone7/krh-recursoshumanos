-- Keep public candidate registrations visible in the vacancy that generated the link.
-- If an older token carries a stale company_id, the vacancy company is authoritative.

DROP FUNCTION IF EXISTS public.submit_candidate_registration(
  text, text, text, text, text, text, text, text, text, text,
  text, text, text, text, text, text, text, integer, text, text,
  numeric, text, text, text, text, text, text, text, text, text,
  boolean, boolean, text, text, boolean, boolean, uuid, uuid, uuid
);
...
BEGIN
  ...
  INSERT INTO candidates (
    ...
    v_vacancy_company_id, v_token_row.vacancy_id, p_first_name, p_last_name, p_document_type::document_type, p_document_number,
