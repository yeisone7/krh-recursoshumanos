...
export const vacancyFormSchema = z.object({
  ...
  educationLevelIds: z.array(z.string().uuid()).default([]),
  professionId: z.string().uuid().optional().or(z.literal('none')),
...
export const candidateFormSchema = z.object({
  ...
  documentIssueCity: z.string().optional(),
  ...
  educationLevel: z.string().optional(),
  educationLevelId: z.string().uuid().optional().or(z.literal('none')),
