  ...
  return (
    <>
      ...
      >
        ...
        <div className="pointer-events-none absolute -right-6 top-10 h-28 w-28 rounded-full bg-success/10 sm:-right-8 sm:top-8 sm:h-36 sm:w-36" />
        <div className="pointer-events-none absolute right-12 -top-20 h-48 w-48 rounded-full border border-success/25 sm:right-20 sm:-top-24 sm:h-56 sm:w-56" />
        <Badge 
          variant="outline" 
          className={cn(
