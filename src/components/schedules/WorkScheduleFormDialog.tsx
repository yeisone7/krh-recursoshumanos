                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem className="space-y-2">
                      ...
                      <FormControl>
                        <Input placeholder="Ej: Administrativo estándar" {...field} className="h-12 rounded-2xl bg-muted/20 border-primary/5 focus:bg-background" />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
                            ...
                            <label
                              ...
                              className={`
                                ...
                                ${isChecked 
                                  ...
                                  : 'bg-muted/20 border-primary/5 hover:bg-muted/50 text-muted-foreground'
                                }
                              `}
                            >
                              <Checkbox
