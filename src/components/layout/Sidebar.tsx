  ...
  return (
    <TooltipProvider>
      <motion.aside
        ...
        className={cn(
          "h-screen bg-sidebar flex flex-col border-r border-sidebar-border relative shadow-sm after:absolute after:right-0 after:top-0 after:h-full after:w-3 after:translate-x-full after:bg-gradient-to-r after:from-foreground/5 after:via-foreground/[0.025] after:to-transparent after:blur-[2px] after:pointer-events-none",
