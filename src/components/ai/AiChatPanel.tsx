...
const moduleSuggestions: Record<string, { module: string; moduleLabel: string; suggestions: string[] }> = {
  ...
  '/jornadas': { module: 'jornadas', moduleLabel: 'Jornadas', suggestions: ['Crear jornada', 'Asignar turno', 'Revisar programación', 'Configurar horario', 'Consultar novedades de turno', 'Validar descansos'] },
  '/novedades': { module: 'novedades', moduleLabel: 'Novedades', suggestions: ['Registrar novedad', 'Consultar novedades', 'Filtrar por empleado', 'Revisar estado', 'Validar soportes', 'Generar reporte'] },
  '/requisiciones': { module: 'requisiciones', moduleLabel: 'Requisiciones', suggestions: ['Crear requisición', 'Aprobar solicitud', 'Revisar trazabilidad', 'Consultar estado', 'Exportar requisición', 'Validar vacantes requeridas'] },
