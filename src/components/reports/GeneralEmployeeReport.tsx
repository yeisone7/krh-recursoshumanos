...
const INTEGER_KEYS = ['edad', 'ciclo_laboral', 'periodo_prueba_dias', 'numero_hijos', 'numero_parientes', 'numero_adjuntos', 'numero_documentos', 'documentos_vencidos', 'numero_certificaciones', 'numero_vacunas'];
