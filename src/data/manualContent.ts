...
export const MODULE_DOCS: ModuleDoc[] = [
  ...
  },
  {
    ...
    title: 'Catálogos',
    icon: 'FolderOpen',
    description: 'Configuración de datos maestros del sistema: centros de operación, áreas, cargos, tipos de contrato, tipos de dotación, entidades de seguridad social (EPS, ARL, AFP, CCF, AFC, IPS), bancos, días festivos y motivos de novedad. Incluye la gestión de perfiles de cargo con sistema de anexos por centro de operación.',
    actions: [
