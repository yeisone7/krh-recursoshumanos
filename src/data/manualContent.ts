...
export const MODULE_DOCS: ModuleDoc[] = [
  ...
  },
  {
    ...
    icon: 'Gavel',
    description: 'Expediente disciplinario por etapas: reporte dinámico de hechos y fotografías, citación, descargos presenciales o por enlace seguro, decisión jurídica, réplica y cierre.',
    actions: ['Reportar hechos y adjuntar registros fotográficos', 'Configurar y generar la citación a descargos', 'Preparar un cuestionario dinámico', 'Generar enlace seguro de descargos con firma', 'Generar el acta de descargos', 'Registrar la decisión jurídica', 'Registrar la réplica o recurso del trabajador', 'Consultar la trazabilidad del expediente'],
    ...
    restrictions: ['El flujo sigue un orden estricto: reporte → investigación → citación → descargos → análisis → decisión → réplica/recurso → cierre', 'El enlace de descargos es secreto, vence y sólo puede utilizarse una vez', 'Las fotografías se almacenan de forma privada y se consultan mediante enlaces temporales'],
  ...
  },
  {
    ...
    actions: ['Crear turnos de trabajo', 'Crear jornadas laborales', 'Configurar ciclos rotativos', 'Asignar turnos a empleados', 'Generar calendario de turnos', 'Exportar jornadas'],
