...
import type { EmployeeFullFormData, EmployeeV2WithRelations } from '@/types/employeeV2';
...
export function useEmployeesV2() {
...
// =====================================================
// GET SINGLE EMPLOYEE V2 (FULL DETAIL)
// =====================================================

export function useEmployeeV2(id: string | undefined) {
  return useQuery({
...
// =====================================================
// CREATE EMPLOYEE V2 (TRANSACTIONAL)
// =====================================================

export function useCreateEmployeeV2() {
...
export function useUpdateEmployeeV2() {
  const queryClient = useQueryClient();
  const { user, currentCompanyId } = useAuth();
...
export function useToggleEmployeeV2Active() {
  const queryClient = useQueryClient();
  const { user, currentCompanyId } = useAuth();
